...
const reserves = [
  {
    member_ID: 1,
    table_ID: 3,
    reserve_time: '2018-11-20 14:00:00',
    number_of_reserved: 3,
    create_time: '2018-11-20 09:00:00'
  }
];
...
mysql_connect(function(db) {
  ...
  const checkMember = callback => {
    db.query(
      'SELECT * FROM `ACCOUNT` a, `MEMBER` e WHERE a.`account_ID` = e.`account_ID`',
      (err, result) => {
